    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.TextField()),
                ('description', models.TextField()),
                ('type', models.CharField(choices=[('Multiple Choice Radio', 'Выбор одного варианта'), ('Multiple Choice Checkbox', 'Выбор нескольких вариантов'), ('Fill In Single Blank', 'Заполнение пропуска'), ('Code', 'Код')], max_length=100)),
