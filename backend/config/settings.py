...
class Constants:
    ...
    TOPIC_THRESHOLD_LOW_COEFFICIENT: float = 1.75
    TOPIC_THRESHOLD_MEDIUM_COEFFICIENT: float = 1.0
    TOPIC_THRESHOLD_HIGH_COEFFICIENT: float = 0.5

    POINTS_EASY: float = 7.0
    POINTS_NORMAL: float = 10.0
    POINTS_HARD: float = 13.0
    ...
    ALGORITHM_SKILL_LEVEL_LOWER_BOUND: float = 1.4
    ...
    SUB_TOPIC_POINTS_THRESHOLD: float = TOPIC_THRESHOLD_LOW
